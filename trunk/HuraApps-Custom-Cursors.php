									...
									<div class="main-section">
										...
										<form action="options.php" method="post">
											...
											<div class="hura-flex hura-cursors" style="margin-top:25px;">									
												...
												<div>
													<label>
														<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'images/cursors/'.'hura-'.$i.'.png'); ?>">
														<input type="radio" name="huraapps_customer_cursor" value="hura-<?php echo esc_attr($i); ?>" <?php echo esc_attr(($config_cursor=='hura-'.$i)?'checked':''); ?>>
													</label>
												</div>
												<?php } ?>
											</div>											
